...
```{r basic-plot, fig.width=7, fig.height=1.2}
...
```{r bootstrap-plot, fig.width=7, fig.height=1.2}
...
```{r subgroup-plot, fig.width=7, fig.height=2}
# Create age groups
data <- data %>%
...
```{r negative-te-1, fig.width=7, fig.height=1.2}
...
```{r negative-te-2, fig.width=7, fig.height=2}
...
```{r customization, fig.width=7, fig.height=1.2}
