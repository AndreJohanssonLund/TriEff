...
```{r example of heatmap, fig.width=7, fig.height=7, fig.alt="A heatmap showing TE over Sensitivity/specificity, unnormalized"}
...
```{r example of heatmap - normalized, fig.width=7, fig.height=7, fig.alt="A heatmap showing TE over Sensitivity/specificity, normalized"}
...
```{r example alt_calc_1, fig.width=10, fig.height=5, fig.alt="The first of three heatmaps from the alternative calculations - plain TE where TE is calculated based on on different normalisation techniques"}
...
```{r example alt_calc_2, fig.width=10, fig.height=5, fig.alt="The second of three heatmaps from the alternative calculations - normalized TE where TE is calculated based on on different normalisation techniques"}

alt_calc$normalized_te_batch # The second possible alternative heat map
```


```{r example alt_calc_3, fig.width=10, fig.height=5, fig.alt="The second of three heatmaps from the alternative calculations - normalized TE where TE is calculated based on on different normalisation techniques"}
