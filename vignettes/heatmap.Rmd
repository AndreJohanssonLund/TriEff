...
for (scheme in color_schemes) {
  color_scheme_plots[[scheme]] <- plot_te_heatmap(
    heatmap_data, 
    normalize = TRUE,
    show_labels = FALSE,  # Turning off labels for cleaner comparison
    color_scheme = scheme,
...
Triage: Uses classic triage colors (red, orange, yellow, green) familiar in healthcare settings. Not colorblind-safe but may be intuitive for healthcare professionals.

OceanSky (default): Uses navy, light blue, light yellow, and gold. Fully colorblind-safe and provides good contrast.

BlueOrange: Uses a blue to orange to red gradient. Colorblind-safe and follows scientific visualization best practices.

ThermalSafe: Uses purple, light blue, yellow, and orange. Colorblind-safe and mimics thermal imaging.
